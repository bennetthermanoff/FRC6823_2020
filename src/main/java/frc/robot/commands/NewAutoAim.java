...
public class NewAutoAim extends SequentialCommandGroup {
    ...
    public NewAutoAim(LimeLightSubsystem limeLightSubsystem, ShooterSubsystem shooterSubsystem,
        ...
        if (position == 0) {
            ...
            // rpm = 5925;
            distance = 124;
            rpm = (Robot.PREFS.getDouble("Zone 2 rpm", 5650));// rpm = 5650; rpm 5150
            ...
            distance = 240;
            // rpm = 9400;
            rpm = (Robot.PREFS.getDouble("Zone 3 rpm", 7100));
        ...
        // swerveDriveSubsystem));
        // }
        // super.addCommands(new NewShoot(shooterSubsystem, power, .3, 20,
        // swerveDriveSubsystem));

...
public class AutoAim3d extends SequentialCommandGroup {
    ...
    public AutoAim3d(LimeLightSubsystem limeLightSubsystem, ShooterSubsystem shooterSubsystem,
        ...
        // limeLightSubsystem)));
        super.addCommands(new MoveTo3d(swerveDriveSubsystem, limeLightSubsystem, 0, distance));
     ...
     * ShooterSubsystem shooterSubsystem, SwerveDriveSubsystem swerveDriveSubsystem,
     * int position)
     * 
     * double distance = -56; double rpm = 8500;
     * 
     * if (position == 0) { distance = -56; rpm = 5925; } else if (position == 1) {
     * distance = -125; rpm = 6575; } else if (position == -1) { distance = -37; rpm
     * = 6000; }
     * 

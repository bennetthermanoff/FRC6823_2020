...
public class AutoAim3dAuto extends SequentialCommandGroup {
    ...
    public AutoAim3dAuto(LimeLightSubsystem limeLightSubsystem, ShooterSubsystem shooterSubsystem,
        ...
        // limeLightSubsystem)));
        super.addCommands(
                new SequentialCommandGroup(new MoveTo3d(swerveDriveSubsystem, limeLightSubsystem, 0, distance),
                        new WaitCommand(0.5), new Shoot(shooterSubsystem, rpm, .2, 8, swerveDriveSubsystem)));
    }
}
// package frc.robot.commands;

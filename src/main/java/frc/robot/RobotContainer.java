...
public class RobotContainer {
        ...
        private Auto autoCommand; // gotta construct auto by giving it the swerve bas
        ...
        public RobotContainer() {
                ...
                autoCommand = new Auto(swerveDriveSubsystem, shooterSubsystem, limeLight);
                CommandScheduler.getInstance().setDefaultCommand(swerveDriveSubsystem, robotSpaceDriveCommand);

                configureButtonBindings();
        }

        public Auto getAutoCommand() {
                return autoCommand;
        }
